// Conjunto unico de icones SVG (stroke, currentColor) — substitui emojis como icones de UI.
// Uso: <Icon name="home" size={16} /> — decorativo por padrao (aria-hidden).
// Para icone com significado proprio, passe `label`: <Icon name="send" label="Enviar" />
...
export default function Icon({ name, size = 16, strokeWidth = 2, label, className = "", style }) {
